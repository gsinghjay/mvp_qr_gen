...
if __name__ == "__main__":
    ...
    print("2. Add a line like: raise ValueError('Forced E2E Test Failure')")
    print("3. Restart the API container: docker-compose restart api")
    print("4. Run the test_circuit_breaker_opens_and_falls_back function")
    print("5. After testing, remember to revert your changes and restart the API")
