...
def assert_qr_code_fields(
    qr_code: QRCode | dict[str, Any], expected_values: dict[str, Any]
) -> bool:
    """
...
def assert_http_exception(
    ...
    if expected_status_code is not None:
        assert (
            exc_info.value.status_code == expected_status_code
    ...
    if expected_detail_substring is not None:
        assert (
            expected_detail_substring in exc_info.value.detail
