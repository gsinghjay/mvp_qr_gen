...
async def test_background_task_with_delay():
    ...
    assert (
        task_data["end_time"] - task_data["start_time"] >= 0.19
...
async def test_client_info_capture_with_real_service(test_db):
    ...
    mock_request.headers = {"User-Agent": "Test User Agent", "Referer": "https://test-referrer.com"}
    ...
    def update_with_client_info():
        ...
        qr_service.update_scan_count(
            test_id, timestamp
        )  # Simplified - would normally pass client_info
